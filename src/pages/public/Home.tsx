  ...
  return (
    <div className="flex flex-col">
      ...
      <a 
        ...
        className="fixed bottom-6 right-6 z-50 bg-pink-500 text-white p-2 rounded-full shadow-md hover:bg-pink-600 hover:scale-110 transition-all duration-300 opacity-70 hover:opacity-100 w-10 h-10 flex items-center justify-center"
